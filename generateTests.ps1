...
Write-Host "CFGrammar 12 6 N"
Measure-Command {python ./CFGrammar.py 12 6 ./rockyou-withcount.txt 12-6-N.gr} > 12-6-N.time
...
Write-Host "CFGrammar 12 6 A"
Measure-Command {python ./CFGrammar.py 12 6 ./rockyou-withcount.txt 12-6-A.gr 1} > 12-6-A.time
...
Write-Host "CFGrammar 13 4 A"
Measure-Command {python ./CFGrammar.py 13 4 ./rockyou-withcount.txt 13-4-A.gr 1} > 13-4-A.time
Write-Host "CFGrammar 14 4 A"
Measure-Command {python ./CFGrammar.py 14 4 ./rockyou-withcount.txt 14-4-A.gr 1} > 14-4-A.time
Write-Host "Finished"